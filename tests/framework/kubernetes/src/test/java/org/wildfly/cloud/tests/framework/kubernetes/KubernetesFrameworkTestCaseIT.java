...
@WildFlyKubernetesIntegrationTest(
        ...
        extraTestSetup = KubernetesExtraTestSetup.class,
...
public class KubernetesFrameworkTestCaseIT extends WildFlyCloudTestCase {
    ...
    public void checkMPConfig() throws Exception {
        Assertions.assertTrue(KubernetesExtraTestSetup.called);
